...
SCAPY_JSON="$SCAPY_JSON" LIBPCAP_JSON="$LIBPCAP_JSON" TCPDUMP_JSON="$TCPDUMP_JSON" RAWSOCK_JSON="$RAWSOCK_JSON" RAWSOCK_TP_JSON="$RAWSOCK_TP_JSON" PYPCAP_JSON="$PYPCAP_JSON" DPKT_JSON="$DPKT_JSON" EBPF_JSON="$EBPF_JSON" python3 - <<'PY'
import json, os
files=[os.environ['SCAPY_JSON'],os.environ['LIBPCAP_JSON'],os.environ['TCPDUMP_JSON'],os.environ['RAWSOCK_JSON'],os.environ['RAWSOCK_TP_JSON'],os.environ['PYPCAP_JSON'],os.environ['DPKT_JSON'],os.environ['EBPF_JSON']]
